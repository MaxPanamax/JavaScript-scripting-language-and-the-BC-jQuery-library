...
function betSuccess() {
    ...
    if (sumAmount <= currAmount && sumAmount > 0) {
        //успешно, затем отклонить
        $("#betPlaced").attr('data-dismiss', 'modal');
        //возвращает присвоенные значения
    }
    else {
...
var userActions = (function () {
    ...
    var colorTrucks = ["Deeppink", "Cyan", "Blue", "Green", "Purple", "Red", "Yellow"];
    ...
    function startRace() {
        ...
        for (var i = 0; i < defaultTruck; i++) {
            ...
            if (truckId != ("truck" + randomTruck)) {
                $('#' + combineId).animate({ marginLeft: runDistance - labelWidth - 1 }); // 1 для буфера
    ...
    function setPlayerAmount() {
       //цикл по trucksBetAmountArray
        //добавьте сумму ставки на каждый грузовик
    }
